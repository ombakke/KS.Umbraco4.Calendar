...
namespace KS.Umbraco4.Calendar.Core
{
    /// <summary>
    ...
    public static class Calendar
    {
        ...
        public static List<CalendarEvent> getEvents(DateTime startDate, DateTime endDate, string propertyType, bool splitNoneRecurring = true)
        {
            ...
            DynamicNodeList nodes = n.Descendants();
        ...
        public static List<CalendarEvent> getEvents(DateTime startDate, DateTime endDate, string propertyType, string documentType, bool splitNoneRecurring = true)
        {
            List<CalendarEvent> events = new List<CalendarEvent>();
            DynamicNode n = new DynamicNode(-1);
            DynamicNodeList nodes = n.Descendants(documentType);
            return getEventList(startDate, endDate, propertyType, nodes, splitNoneRecurring);
        }
        ...
        ///<param name="splitNoneRecurring">Optional: Split none recurring events by day, true by default</param>
        ///<returns>An ordered List with CalendarEvents ordered by startDate</returns>
        public static List<CalendarEvent> getEvents(DateTime startDate, DateTime endDate, string propertyType, string documentType, DynamicNode startNode, bool splitNoneRecurring = true)
        {
            List<CalendarEvent> events = new List<CalendarEvent>();
        ...
        public static List<CalendarEvent> getEvents(DateTime startDate, DateTime endDate, string propertyType, string documentType, int nodeId, bool splitNoneRecurring = true)
        {
            ...
            try
            {
                node = new DynamicNode(nodeId);
            }
            catch (Exception ex)
            {
                node = new DynamicNode(-1);
            }
            if (node != null)
            {
        ...
        ///<param name="splitNoneRecurring">Optional: Split none recurring events by day, true by default</param>
        ///<returns>An ordered List with CalendarEvents ordered by startDate</returns>
        public static List<CalendarEvent> getEvents(DateTime startDate, DateTime endDate, string propertyType, DynamicNode startNode, bool splitNoneRecurring = true)
        {
            List<CalendarEvent> events = new List<CalendarEvent>();
        ...
        ///<param name="splitNoneRecurring">Optional: Split none recurring events by day, true by default</param>
        ///<returns>An ordered List with CalendarEvents ordered by startDate</returns>
        public static List<CalendarEvent> getEventList(DateTime startDate, DateTime endDate, string propertyType, dynamic nodes, bool splitNoneRecurring = true)
        {
            ...
            try
            {
                foreach (DynamicNode node in nodes)
                {
                    if (node.HasValue(propertyType))
                    {
                        ...
                        if (((startDate <= e.startDate || e.recurrence > 1 || (e.endDate.HasValue && e.endDate.Value <= endDate)) && e.startDate <= endDate) && (string.IsNullOrEmpty(e.endDate.ToString()) || startDate <= e.endDate) && !(e.recurrence > 1 && string.IsNullOrEmpty(e.endDate.ToString())))
                        {
