...
namespace KS.Umbraco4.Calendar.Core
{
    ...
    public static class Calendar
    {
        ...
        public static List<CalendarEvent> getEvents(DateTime startDate, DateTime endDate, string propertyType)
        {
            ...
            //DynamicNode n = new DynamicNode(0);
            DynamicNode n = new DynamicNode(-1);

            DynamicNodeList nodes = n.Descendants();
            var something = getEventList(startDate, endDate, propertyType, nodes);
            return something;
        }
        ...
        ///<returns>An ordered List with CalendarEvents ordered by startDate</returns>
        public static List<CalendarEvent> getEvents(DateTime startDate, DateTime endDate, string propertyType, string documentType, DynamicNode startNode)
        {
            List<CalendarEvent> events = new List<CalendarEvent>();
        ...
        ///<param name="startNode">DynamicPublishedConent to look for events in</param>
        ///<returns>An ordered List with CalendarEvents ordered by startDate</returns>
        public static List<CalendarEvent> getEvents(DateTime startDate, DateTime endDate, string propertyType, DynamicNode startNode)
        {
            List<CalendarEvent> events = new List<CalendarEvent>();
        ...
        ///<returns>An ordered List with CalendarEvents ordered by startDate</returns>
        public static List<CalendarEvent> getEventList(DateTime startDate, DateTime endDate, string propertyType, dynamic nodes)
        {
